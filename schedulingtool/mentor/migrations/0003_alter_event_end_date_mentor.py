...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mentor', '0002_remove_event_title_alter_event_end_date'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='event',
            name='end_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 4, 22, 10, 50, 37, 734245)),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentors', to='mentor.event')),
            ],
        ),
    ]
